...
var videos = [
  ...
  },
  {
	...
	{
		"youtubeId":"FgFeVlw2Ywg",
		"title":"Alton Brown Reviews...",
...
var addVideoToList = function(video) {
	...
	if (video.fave) {
		videoItem.style.border = "2px solid red";
	}
	...
	videoLink.addEventListener('click', function(e){
		...
		var titleDisplay = document.createElement('h2');
		titleDisplay.innerHTML = video.title + " by " + video.author;
		...
		playerContainer.insertBefore(titleDisplay, videoEmbed);
